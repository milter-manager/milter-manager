...
void             milter_encoder_encode_reply_reply_code
                                               (MilterEncoder     *encoder,
                                                ...
                                                gsize             *packet_size,
                                                const gchar       *code);
void             milter_encoder_encode_reply_temporary_failure
                                               (MilterEncoder     *encoder,
                                                gchar            **packet,
                                                gsize             *packet_size);
void             milter_encoder_encode_reply_reject
                                               (MilterEncoder     *encoder,
                                                gchar            **packet,
                                                gsize             *packet_size);
void             milter_encoder_encode_reply_accept
                                               (MilterEncoder     *encoder,
                                                gchar            **packet,
                                                gsize             *packet_size);
...
void             milter_encoder_encode_reply_add_header
                                               (MilterEncoder     *encoder,
                                                ...
                                                const gchar       *name,
                                                const gchar       *value);
void             milter_encoder_encode_reply_insert_header
                                               (MilterEncoder     *encoder,
                                                gchar            **packet,
                                                gsize             *packet_size,
                                                guint32            index,
...
void             milter_encoder_encode_reply_change_header
                                               (MilterEncoder     *encoder,
                                                ...
                                                guint32            index,
                                                const gchar       *value);
void             milter_encoder_encode_reply_change_from
                                               (MilterEncoder     *encoder,
                                                gchar            **packet,
                                                gsize             *packet_size,
                                                const gchar       *from,
...
void             milter_encoder_encode_reply_add_receipt
                                               (MilterEncoder     *encoder,
                                                ...
                                                const gchar       *receipt,
                                                const gchar       *parameters);
void             milter_encoder_encode_reply_delete_receipt
                                               (MilterEncoder     *encoder,
                                                gchar            **packet,
                                                gsize             *packet_size,
                                                const gchar       *receipt);
