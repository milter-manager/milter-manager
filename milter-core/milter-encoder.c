...
void
milter_encoder_encode_helo (MilterEncoder *encoder,
                            gchar **packet, gsize *packet_size,
                            const gchar *fqdn)
{
    MilterEncoderPrivate *priv;
    ...
    g_string_append_c(priv->buffer, MILTER_COMMAND_HELO);
    g_string_append(priv->buffer, fqdn);
    g_string_append_c(priv->buffer, '\0');
    pack(priv->buffer);
...
void
milter_encoder_encode_mail (MilterEncoder *encoder,
                            gchar **packet, gsize *packet_size,
                            const gchar *from)
{
    MilterEncoderPrivate *priv;
    ...
    g_string_append_c(priv->buffer, MILTER_COMMAND_MAIL);
...
void
milter_encoder_encode_header (MilterEncoder *encoder,
                              gchar **packet, gsize *packet_size,
                              const gchar *name, const gchar *value)
{
    ...
    g_string_append_c(priv->buffer, MILTER_COMMAND_HEADER);
...
void
milter_encoder_encode_body (MilterEncoder *encoder,
                            gchar **packet, gsize *packet_size,
...
void
milter_encoder_encode_end_of_message (MilterEncoder *encoder,
                                      gchar **packet, gsize *packet_size,
                                      const gchar *chunk, gsize size)
{
    MilterEncoderPrivate *priv;
...
void
milter_encoder_encode_abort (MilterEncoder *encoder,
                             gchar **packet, gsize *packet_size)
{
    MilterEncoderPrivate *priv;
    ...
    g_string_append_c(priv->buffer, MILTER_COMMAND_ABORT);
    pack(priv->buffer);
...
void
milter_encoder_encode_quit (MilterEncoder *encoder,
                            gchar **packet, gsize *packet_size)
{
    MilterEncoderPrivate *priv;
    ...
    g_string_append_c(priv->buffer, MILTER_COMMAND_QUIT);
    pack(priv->buffer);
...
void
milter_encoder_encode_unknown (MilterEncoder *encoder,
                               gchar **packet, gsize *packet_size,
                               const gchar *command)
{
    MilterEncoderPrivate *priv;
    ...
    g_string_append_c(priv->buffer, MILTER_COMMAND_UNKNOWN);
    g_string_append(priv->buffer, command);
    g_string_append_c(priv->buffer, '\0');
    pack(priv->buffer);
...
void
milter_encoder_encode_reply_continue (MilterEncoder *encoder,
                                      gchar **packet, gsize *packet_size)
{
    MilterEncoderPrivate *priv;
    ...
    g_string_append_c(priv->buffer, MILTER_REPLY_CONTINUE);
    pack(priv->buffer);
...
void
milter_encoder_encode_reply_reply_code (MilterEncoder *encoder,
                                        gchar **packet, gsize *packet_size,
                                        const gchar *code)
{
    MilterEncoderPrivate *priv;
    ...
    g_string_append_c(priv->buffer, MILTER_REPLY_REPLY_CODE);
    g_string_append(priv->buffer, code);
    g_string_append_c(priv->buffer, '\0');
    pack(priv->buffer);
...
void
milter_encoder_encode_reply_accept (MilterEncoder *encoder,
                                    gchar **packet, gsize *packet_size)
{
    MilterEncoderPrivate *priv;
    ...
    g_string_append_c(priv->buffer, MILTER_REPLY_ACCEPT);
    pack(priv->buffer);
...
void
milter_encoder_encode_reply_discard (MilterEncoder *encoder,
                                     gchar **packet, gsize *packet_size)
{
    MilterEncoderPrivate *priv;
    ...
    g_string_append_c(priv->buffer, MILTER_REPLY_DISCARD);
    pack(priv->buffer);
...
void
milter_encoder_encode_reply_progress (MilterEncoder *encoder,
                                      gchar **packet, gsize *packet_size)
{
    MilterEncoderPrivate *priv;
    ...
    g_string_append_c(priv->buffer, MILTER_REPLY_PROGRESS);
    pack(priv->buffer);
