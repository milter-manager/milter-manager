...
static void
cb_success (MilterManagerReplyDecoder *decoder, gpointer user_data)
{
    n_success_received++;
}

static void
cb_failure (MilterManagerReplyDecoder *decoder,
...
static void
cb_error (MilterManagerReplyDecoder *decoder,
          const gchar *message, gpointer user_data)
{
    n_error_received++;
...
setup (void)
{
    decoder = milter_manager_reply_decoder_new();
