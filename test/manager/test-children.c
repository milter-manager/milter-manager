...
#define test_data(state, status, next_status)                   \
    ...
    cut_add_data("connect - default - accept",
                 ...
                 test_data(BODY, QUARANTINE, REJECT),
                 g_free,
                 "body - quarantine - discard",
                 test_data(BODY, QUARANTINE, DISCARD),
                 g_free,
                 "body - skip - quarantine",
                 test_data(BODY, SKIP, QUARANTINE),
                 g_free,
                 "body - accept - quarantine",
                 test_data(BODY, ACCEPT, QUARANTINE),
                 g_free,
                 "body - skip - discard",
...
#define test_data(state, status, next_status)                   \
    ...
    cut_add_data("connect - continue - accept",
                 ...
                 g_free,
                 "body - reject - quarantine",
                 test_data(BODY, REJECT, QUARANTINE),
                 g_free,
                 "body - quarantine - accept",
                 test_data(BODY, QUARANTINE, ACCEPT),
                 g_free,
                 "body - continue - skip",
