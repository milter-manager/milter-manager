...
typedef enum
{
    MILTER_READER_ERROR_NO_WRITE_FUNC,
    MILTER_READER_ERROR_NO_DATA
} MilterReaderError;
...
MilterReader    *milter_reader_string_new     (GString          *string);
MilterReader    *milter_reader_io_channel_new (GIOChannel       *channel);

gboolean         milter_reader_read           (MilterReader     *reader,
                                               gchar           **read_data,
                                               gsize            *read_size,
                                               GError          **error);
