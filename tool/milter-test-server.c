...
static const GOptionEntry option_entries[] =
{
    ...
    {"recipients", 'r', 0, G_OPTION_ARG_STRING_ARRAY, &recipients,
     N_("Set recipients"), "RECIPIENT"},
    {"headers", 'h', 0, G_OPTION_ARG_CALLBACK, parse_header_arg,
     N_("Set headers"), "HEADER_NAME:HEADER_VALUE"},
    {"body", 'b', 0, G_OPTION_ARG_STRING_ARRAY, &body_chunks,
     N_("Set body chunks"), "CHUNKS"},
    {"mail-file", 'm', 0, G_OPTION_ARG_CALLBACK, parse_mail_file_arg,
     N_("Set mail file name"), "FILENAME"},
    {"output-message", 0, G_OPTION_FLAG_NO_ARG, G_OPTION_ARG_NONE, &output_message,
