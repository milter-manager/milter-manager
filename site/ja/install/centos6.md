...
/var/run/milter-greylist/ディレクトリはmilter-greylistの実行ユーザーであるgrmilterユーザーのみがアクセスできるようになっています。milter-managerも/var/run/milter-greylist/以下にあるソケットファイルにアクセスできるようにします。
