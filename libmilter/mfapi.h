...
#define SMFIS_CONTINUE    MILTER_CLIENT_STATUS_CONTINUE
#define SMFIS_REJECT      MILTER_CLIENT_STATUS_REJECT
#define SMFIS_DISCARD     MILTER_CLIENT_STATUS_DISCARD
#define SMFIS_ACCEPT	  MILTER_CLIENT_STATUS_ACCEPT
#define SMFIS_TEMPFAIL	  MILTER_CLIENT_STATUS_TEMPORARY_FAILURE
#define SMFIS_NOREPLY     MILTER_CLIENT_STATUS_NO_REPLY
#define SMFIS_SKIP        MILTER_CLIENT_STATUS_SKIP
#define SMFIS_ALL_OPTS	  MILTER_CLIENT_STATUS_ALL_OPTIONS
