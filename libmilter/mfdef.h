...
#define SMFIR_ADDRCPT         MILTER_REPLY_ADD_RECIPIENT
#define SMFIR_DELRCPT         MILTER_REPLY_DELETE_RECIPIENT
#define SMFIR_ADDRCPT_PAR     MILTER_REPLY_ADD_RECIPIENT_PARAMETERS
